    ...
    return (
        <section className={`w-full py-8 global-px ${className}`}>
            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-7 mt-10 justify-items-center md:justify-items-start md:justify-items-start">
